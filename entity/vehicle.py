class Vehicle:
    def __init__(self, make="", model="", year=0, dailyRate=0.0, status="available", passengerCapacity=0, engineCapacity=0):
        # Initialize without vehicle_id since it's auto-incremented in the DB
        self.__vehicleID = None  # Placeholder for vehicle_id, set after DB insert
        self.__make = make
        self.__model = model
        self.__year = year
